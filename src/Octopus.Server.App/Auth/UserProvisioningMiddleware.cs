...
public class UserProvisioningMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, OctopusDbContext dbContext)
    {
        if (context.User.Identity?.IsAuthenticated == true)
        {
            ...
            if (!string.IsNullOrEmpty(subject))
            {
                ...
                if (user != null)
                {
                    ...
                    context.Items["OctopusUserId"] = user.Id;
                }
            }
        }
    ...
    private async Task<User?> ProvisionUserAsync(HttpContext context, OctopusDbContext dbContext, string subject)
    {
