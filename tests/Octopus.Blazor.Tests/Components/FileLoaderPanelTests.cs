...
namespace Octopus.Blazor.Tests.Components;
...
public class FileLoaderPanelTests : TestContext
{
    ...
    {
        // Arrange - AddOctopusBlazorServer is for IFC processing, still standalone mode
    ...
    [Fact]
    public void FileLoaderPanel_WithAddOctopusBlazor_ShouldWork()
    {
