...
using Xbim.Server.App.Storage;
using Xbim.Server.Contracts;
using Xbim.Server.Domain.Entities;
using Xbim.Server.Persistence.EfCore;

using ProjectRole = Xbim.Server.Domain.Enums.ProjectRole;
using DomainUploadSessionStatus = Xbim.Server.Domain.Enums.UploadSessionStatus;
using DomainUploadMode = Xbim.Server.Domain.Enums.UploadMode;
using FileKind = Xbim.Server.Contracts.FileKind;
using FileCategory = Xbim.Server.Contracts.FileCategory;
using UploadMode = Xbim.Server.Contracts.UploadMode;
using static Xbim.Server.Abstractions.Auth.OAuthScopes;

namespace Xbim.Server.App.Endpoints;
