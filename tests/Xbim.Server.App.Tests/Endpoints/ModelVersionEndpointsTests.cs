...
using WorkspaceRole = Xbim.Server.Domain.Enums.WorkspaceRole;
using ProjectRole = Xbim.Server.Domain.Enums.ProjectRole;
using DomainFileKind = Xbim.Server.Domain.Enums.FileKind;
using DomainFileCategory = Xbim.Server.Domain.Enums.FileCategory;

namespace Xbim.Server.App.Tests.Endpoints;
